/**
 * ========================================
 * EDUSPHERE - Theme Management
 * ========================================
 */

class ThemeManager {
  constructor() {
    this.theme = localStorage.getItem('edusphere-theme') || 'light';
  ...
  setupSystemPreference() {
    if (!localStorage.getItem('edusphere-theme')) {
  ...
  updateIcon(theme) {
    const icon = this.toggleBtn?.querySelector('i, svg');
    if (!icon) return;
